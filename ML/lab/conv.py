# -*- coding: utf-8 -*-
"""
Created on Sun Aug 12 03:01:50 2018
...
path="C:\\Users\\allen\\Desktop\\Esther\\dl\\conv\\";
model_path="C:\\Users\\allen\\Desktop\\Esther\\dl\\conv\\model\\";
trian_path="C:\\Users\\allen\\Desktop\\Esther\\dl\\Training\\all\\mlp\\";
test_path="C:\\Users\\allen\\Desktop\\Esther\\dl\\Testing\\mlp\\";


filep=open(path+'dl_conv_result.txt',"a")
...
filep.close()
filep_2=open(path+'dl_conv_result_score.txt',"a")
...
#    shuffle=True,
    ...
    print(file_name)
    file_save = model_path+file_name+'_conv.h5'
