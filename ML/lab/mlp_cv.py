...
path="C:\\Users\\allen\\Desktop\\Esther\\dl\\mlp_cv\\";
...
# filep=open(path+'dl_mlp_cv_result.txt',"a")
...
# filep.close()
# filep_2 = open(path+'dl_mlp_cv_result_score.txt',"a")
...
#            shuffle=True,
        ...
        for num in range(0,len(resultsClass2)):
            if y[test][num][0] == 1.0 and resultsClass2[num] == 0:
                tn += 1
                y_ans.append(0)
                ...
                filep_2.close()
            elif y[test][num][0] == 1.0 and resultsClass2[num] == 1:
                fp += 1
                y_ans.append(0)
                pred.append(results[num][1])
                filep_2 = open(path+'dl_mlp_cv_result_score.txt',"a")
                ...
                filep_2.write(str(results[num][1])+'\n')
                filep_2.close()
            elif y[test][num][0] == 0.0 and resultsClass2[num] == 1:
                tp += 1
                y_ans.append(1)
                pred.append(results[num][1])
                filep_2 = open(path+'dl_mlp_cv_result_score.txt',"a")
                ...
                filep_2.write(str(results[num][1])+'\n')
                filep_2.close()
            elif y[test][num][0] == 0.0 and resultsClass2[num] == 0:
                fn += 1
                y_ans.append(1)
                pred.append(results[num][1])
                filep_2 = open(path+'dl_mlp_cv_result_score.txt',"a")
