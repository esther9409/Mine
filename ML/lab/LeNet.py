...
path="C:\\Users\\allen\\Desktop\\Esther\\dl\\LeNet\\";
model_path="C:\\Users\\allen\\Desktop\\Esther\\dl\\LeNet\\model\\";
trian_path="C:\\Users\\allen\\Desktop\\Esther\\dl\\Training\\all\\mlp\\";
test_path="C:\\Users\\allen\\Desktop\\Esther\\dl\\Testing\\mlp\\";


# filep=open(path+'dl_LeNet_result.txt',"a")
...
# filep.close()
# filep_2=open(path+'dl_LeNet_result_score.txt',"a")
...
#    test_x2 = np.expand_dims(test_x2, axis=2)
    ...
    model.compile(loss=tf.keras.losses.categorical_crossentropy,
                  ...
                  # optimizer=tf.keras.optimizers.RMSprop(lr=0.0001, clipnorm=1.),
...
#    shuffle=True,
    ...
    print(file_name)
    file_save = model_path+file_name+'_LeNet.h5'
