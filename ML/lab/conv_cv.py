...
path="C:\\Users\\allen\\Desktop\\Esther\\dl\\conv_cv\\";
...
filep=open(path+'dl_conv_cv_result.txt',"a")
...
filep.close()
filep=open(path+'dl_conv_cv_result_score.txt',"a")
...
#            shuffle=True,
        ...
        for num in range(0,len(resultsClass2)):
            if test_x2[num][0] == 1.0 and test_x2[num][1] == 0.0 and resultsClass2[num] == 0:
                ...
                filep_2=open(path+'dl_conv_cv_result_score.txt',"a")
